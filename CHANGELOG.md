...
* use shortened author list in headers to prevent overflow ([794428a](https://github.com/omega-pcf/01-hilbert-polya/commit/794428ac7fd4b2c40c6fd6612e9e588ef5087d90))
...
* remove bold from Lean 4 in abstract ([830f312](https://github.com/omega-pcf/01-hilbert-polya/commit/830f31276f80e29cf91dea5d0e17855a3a40f3e0))

### Build System

* standardizing bibliographic metadata and manuscript formatting ([0e0563b](https://github.com/omega-pcf/01-hilbert-polya/commit/0e0563b21cf734ffba0082d967523709e7c6662f))

## [2.0.8](https://github.com/omega-pcf/01-hilbert-polya/compare/v2.0.7...v2.0.8) (2026-04-12)
...
* standardize terminology from Polya-Hilbert to Hilbert-Polya ([d621bc2](https://github.com/omega-pcf/01-hilbert-polya/commit/d621bc2f818dac18d95607cfa82357ebff315425))
...
* Complete manuscript transcription and resolve LaTeX cross-reference/formatting issues 8e0244a
* integrate complete V10.md manuscript from lead author 3d02c96

### Bug Fixes

* add critical missing labels to resolve reference mismatches 97478fd
* add labels for circularity and phi-emergence 6d0c8c5
* add labels for data methodology, arithmetic arena, and basel-triangular 5d3b568
* add labels for logarithmic isomorphism and other sections a49d3bf
* add labels for modulus and internal-angle propositions 0cad62f
* add labels for orbit classification and mediator proposition 5457874
* add labels for verification sections and mediator theorem 502955b
* add missing \end{Observation} and content for obs:non-hermiticity 6d8392e
* add missing labels to Observation environments 4fca78f
* add missing section labels to methods and results 4bb130c
* add more missing section and observation labels fd939e7
* Corrects date and version inconsistencies d6820aa
* Corrects typographical errors ea332ce
* replace \phi with \varphi for golden ratio notation 773e4b4
...
* **release:** migrate to TypeScript config with conventional changelog 3a7f1b6
