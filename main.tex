...
\author{\fnms{Itzel Marion} \snm{DRESSLER PÉREZ}\ead[label=e3]{itzel@omega-pcf.com}}
\author{\fnms{Luz María} \snm{GARCÍA ORDÓÑEZ}\ead[label=e4]{luz@ttamayo.com}}
\author{\fnms{M.} \snm{MORENO}\ead[label=e5]{}}
\address{Independent Researcher\\\printead{e3}, \printead{e4}, \printead{e5}}
\end{aug}
