...
\title[Hilbert--P\'olya Operator]{The Hilbert--P\'olya Operator and the Primitive Structure of the Complex Plane: Between\/ $\mathbb{F}_1$, String Theory, and Ancient Geometry}
...
\date{\textbf{Received:} November 15, 2025; \textbf{Last modified:} April 23, 2026; \textbf{Compiled:} \today}

\keywords{Riemann Hypothesis, Hilbert--P\'olya conjecture, field with one element, $\Lambda$-rings, String theory, Category theory, Golden ratio, Mersenne primes, Moduli spaces, Formal verification}
