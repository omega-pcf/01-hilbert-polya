...
$G\colon\Ztwenty\to\mathbb{Z}_2\times\mathbb{Z}_2$
(\cref{def:galois-functor}), producing four real Dirichlet
characters $\tilde\chi_j$ (since $\mathbb{Z}_2\times\mathbb{Z}_2$ has
exponent~$2$, \cref{prop:exponent-two}).  The tripartite $S_3$
...
(Eqs.~\cref{eq:Omega-hat-eigenvalues}, \cref{eq:modulus-Omega},
\cref{eq:Omega-hat-0-re}, \cref{eq:Omega-hat-unique-positive-re}).
