...
The reported numerical precision of ${}<10^{-14}$ reflects the computational
verification of this formal identity---which holds exactly in the symbolic
limit---across the 51 known Mersenne primes, spanning over 25 million
orders of magnitude.
\end{proof}
