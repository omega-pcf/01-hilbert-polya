...
with $90^\circ$ fundamental cell (Gauss structure).  
The underlying planar projections (top views) map the $120^\circ$ circle 
($R_0 = 3$) onto the square modular parameter $\tau = i$ within the 
$M \times M$ fundamental cell.  Golden mediation preserves the 
