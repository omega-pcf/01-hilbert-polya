...
that will be mathematically developed in~\S3--\S5.


%%% ====================================================================
%%% §2.1 — THE DUAL GENEALOGY OF THE MODULUS
%%% ====================================================================

\subsection{The dual genealogy of the modulus}\label{ssec:modulus}\label{sec:moduli}
...
Riemann~\cite{riemann57} (1857, ``Theorie der Abel'schen Functionen'') generalized from
...
%%% ====================================================================
%%% §2.2 — THE MATHEMATICAL STRUCTURE OF C
%%% ====================================================================

\subsection{The mathematical structure of
$\mathbb{C}$}\label{ssec:C-structure}\label{sec:complex-plane}
...
%%% ====================================================================
%%% §2.3 — THE FROBENIUS BARRIER
%%% ====================================================================

\subsection{The Frobenius barrier: algebraic impossibility versus obstruction and geometric viability}\label{ssec:frobenius}\label{sec:restrictions}
...
four-dimensional, with non-commutative multiplication~\cite{hamilton}.
...
are reviewed in~\S1.3).  The temporal convergence is striking:
...
%%% ====================================================================
%%% §2.4 — THE DECIDABILITY BOUNDARY AND ITS CATEGORICAL FORMALIZATION
%%% ====================================================================

\subsection{The decidability boundary and its categorical
formalization}\label{ssec:decidability}

The introduction (\S1.3) identified three circumvention strategies
...
algebraic one~\cite{tarskigivant99}.
  The connection between these strategies was
...
Tarski~\cite{tarski48} (1948, 1951) showed that the first-order theory of
...
system can be constructed''~\cite[p.\,45]{tarski48}.  The boundary
...
Mostowski's observation in Tarski~\cite[Note~5, p.\,51]{tarski48}
...
fragment.  The Lawvere--Yanofsky diagonal (\S1.2) cannot form because
...
functors, and topos theory~\cite{grothendieck_sga4} (1960s) introduced three structural
...
(SGA~4)~\cite{grothendieck_sga4} replaces open sets with covering families of morphisms.  A
...
with one element'' (Tits~\cite{tits57}, Soul\'e~\cite{soule04}) that exist as functors rather than classical
geometric objects.  Borger's~\cite{borger09} identification of $\Lambda$-ring
structures as $\mathbb{F}_1$-descent data (\S1.4 of the introduction)
...
in the introduction (\S1.3): the domain where Lawvere's diagonal
...
%%% ====================================================================
%%% §2.5 — PHYSICAL REALIZATIONS OF DIMENSIONAL TRANSCENDENCE
%%% ====================================================================

\subsection{Physical realizations of dimensional transcendence}\label{ssec:physical}
...
tower}\label{sssec:strings}\label{sec:string}
...
The Huerta--Schreiber tower~\cite{huerta17} (\S1.4) derives M-theory's dimensional
...
$\mathbb{F}_1 \cong D^1_{\mathrm{compact}}$}\label{sec:connes}\label{sec:manin}\label{sec:f1-geometric}

The Connes--Douglas--Schwarz
equivalence~\cite{cds98}, introduced in~\S1.4, connects toroidal
...
($\golden$-mediated, as the construction of~\S3 will demonstrate) but
no field extension---a topological $S^1$ that does not correspond to
any algebraic element.


%%% ====================================================================
%%% §2.6 — THE GEOMETRIC PRECEDENT: WEIL'S PROOF
%%% ====================================================================

\subsection{The geometric precedent: Weil's proof for function
fields}\label{ssec:weil}

The introduction (\S1.2) established that the Riemann Hypothesis is
a theorem for function fields (Hasse~\cite{hasse34} 1934, Weil~\cite{weil40} 1940, Deligne~\cite{deligne74} 1974)
...
categorical construction of~\S5 reproduces.
...
\begin{enumerate}[label=(\roman*)]
  \item \textbf{The arithmetic surface.}  The proof requires
    ...
    geometry.  Manin's noncommutative tori~\cite{manin02} (\S1.4) provide the
  ...
  \item \textbf{The Frobenius endomorphism.}  The proof requires
    ...
    $\Lambda$-ring structures (\S1.2) provide the characteristic-zero
  ...
  \item \textbf{The squeeze from intersection theory.}  The proof
    ...
    the categorical setting (\S5 of this paper): two independent
...
construction of~\S5 provides an explicit realization: two
...
%%% ====================================================================
%%% §2.7 — CONVERGENCE AND STRUCTURAL PRINCIPLES
%%% ====================================================================
...
extracting the design principles for the construction of~\S3.
