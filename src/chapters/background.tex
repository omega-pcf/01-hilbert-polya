...
Frobenius's theorem~\cite{frobenius1878} (1877) closed the question definitively: no
...
The Huerta--Schreiber tower~\cite{huerta2018m} (\S\ref{ssec:convergence}) derives M-theory's dimensional
...
equivalence~\cite{connes98}, introduced in~\S\ref{ssec:convergence}, connects toroidal
...
$|\alpha_i| = q^{1/2}$~\cite{oort91,milne15}.
...
\begin{enumerate}[label=(\roman*)]
  \item \textbf{The arithmetic surface.}  The proof requires
    ...
    geometry.  Manin's noncommutative tori~\cite{manin04} (\S\ref{ssec:convergence}) provide the
