...
Tarski~\cite{tarski52} (1948, 1951) showed that the first-order theory of
...
system can be constructed''~\cite[p.\,45]{tarski52}.  The boundary
...
Mostowski's observation in Tarski~\cite[Note~5, p.\,51]{tarski52}
...
Teichm\"uller's moduli spaces~\cite{teichmuller39} (\S\ref{ssec:C-structure}) received
...
with one element'' (Tits~\cite{soule03}) that exist as functors rather than classical
