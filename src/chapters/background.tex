...
a theorem for function fields (Hasse~\cite{hasse34}, Weil~\cite{weil48}, Deligne~\cite{deligne74})
and that the aspiration to transport this proof
from~$\mathbb{F}_q$ to~$\mathbb{Z}$ motivates the
$\mathbb{F}_1$-program.  The proof for general varieties was completed by Deligne using the \'etale framework of Serre~\cite{serre55} and Grothendieck~\cite{grothendieck1960elements}.  We develop here the \emph{technical
