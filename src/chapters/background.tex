...
c.~25~BC, Book~IV, \S~3) defines the modulus as the semi-diameter of a
...
The introduction (\cref{ssec:double-obstruction}) established that the Riemann Hypothesis is
