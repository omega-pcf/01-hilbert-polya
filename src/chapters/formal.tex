...
\begin{enumerate}
    ...
    \item \textbf{Tower from $\phi$-scaling rather than Hamiltonian generation} (\S 2.1--2.3): The construction derives tower $\{\epsilon(\sigma) = \epsilon_0\phi^\sigma : \sigma \in \mathbb{R}\}$ from golden ratio scaling.
\end{enumerate}
