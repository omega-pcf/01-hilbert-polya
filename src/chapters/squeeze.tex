...
This section provides the formal derivation of the critical line $\mathrm{Re}(s)=1/2$ within the PCF framework. The ``squeeze'' strategy is prioritized here for its direct correspondence with the computer-assisted formalization in Lean~4; every deductive step, from the arithmetic bound to the final identification, maps to a verified witness in the repository (see Appendix~\ref{app:lean} for the full deductive trace).
...
Proposition~\ref{prop:bounds-independent}.  Each deductive step
