...
\noindent\textit{Source:} (Verified in Lean~4).\medskip
...
The conclusion follows by \texttt{linarith}.
...
assembled in \lean{master\_bridge\allowbreak \_v11} (Verified in Lean~4), 
