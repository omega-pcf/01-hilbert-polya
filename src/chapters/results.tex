...
\\
\emph{(c)} \textbf{No tuning.}  Every parameter is derived structurally (\cref{ssec:non-circularity}).  The error profile emerges from the interaction of fixed structural parameters with the Riemann--von~Mangoldt asymptotics.
