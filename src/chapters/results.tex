...
\begin{figure}[p]
\centering
\includegraphics[width=0.92\textwidth]{src/assets/placeholders/fig_dual_spectrum.jpg}
...
dividing yields~\eqref{eq:bias-decomp}. \qed
\end{proof}
...
a second crossing $R(n) = 1$ at $n \approx 10^{77}$. \qed
\end{proof}
