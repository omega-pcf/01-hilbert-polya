...
The formalization comprises two verified files that establish a closed deductive chain with zero \texttt{sorry} and axioms limited to the geometric constants of \S\ref{ssec:axioms} and Hecke's 1920 theorem:
...
Formalization of the convergence properties of $T^*$ (\S\ref{ch:results}) and the bias factors:
