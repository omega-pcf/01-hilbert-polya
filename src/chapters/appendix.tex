...
The file \texttt{PCF\_Complete\_v11\_Unified.lean} contains the core 
categorical logic and the squeeze proof. 
Similarly, \texttt{PCF\_OperatorConvergence.lean} provides the formal 
convergence certificates for the operators $T^*(n)$ and $t_n$.
