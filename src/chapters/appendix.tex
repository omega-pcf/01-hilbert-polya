...
\midrule
1  & \lean{primes_land_in_Z20star} & \lean{fin_cases} + \texttt{ZMod} mapping \\
2  & \lean{mul_preserved_Z20} & \lean{decide} (64 pairs in $\Ztwenty$) \\
3  & \lean{addition_destroyed} & \lean{decide} (64 pairs; parity check) \\
...
13 & \lean{no_diagonal_obstr} & $\lnot(1/2 \le 1/4)$ via No-Diagonal \\
\bottomrule
\end{tabular}
\end{center}
