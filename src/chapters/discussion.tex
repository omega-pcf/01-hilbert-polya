...
\subsection{Orbit Classification} \label{sec:orbit-classification}
...
\subsection{Criterion 6: Non-Circularity} \label{sec:circularity}
...
\subsection{The Exhaustiveness Question} \label{sec:exhaustiveness}
...
\begin{Proposition} \label{prop:conditional-rh}
