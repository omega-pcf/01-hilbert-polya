...
\subsection{PCF as $\mathbb{F}_1$-Descent Data}
...
\subsection{Verification Summary: Eight Criteria at 50-Digit Precision}
...
\subsection{Criterion 4: Weil Intersection Form}
...
\subsection{Criterion 7: $\Lambda$-Ring Compatibility}
...
\subsection{Criterion 8: Canonical Selection}
...
\begin{Conjecture}[Maximality of $R_{\text{PCF}}$]
...
\subsection{The Vitruvian Synthesis}
