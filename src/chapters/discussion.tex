...
arithmetic (\lean{bounded_by_mu}) and Hecke self-duality
(\lean{companion_bounded}).  The arithmetic
...
This complementarity is formalized in Lean: \lean{addition_destroyed}
