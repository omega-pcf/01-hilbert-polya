...
(\lean{rh\_squeeze}, Theorem~\ref{thm:rh-squeeze}).  The chain is formalized in Lean~4 and verified against Mathlib, with axioms limited to the geometric constants of~\S\ref{ssec:axioms} and \lean{hecke\_1920}. Hecke's 1920
