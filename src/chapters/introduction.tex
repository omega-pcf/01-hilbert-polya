...
Connes's noncommutative geometry program~\cite{connes99,connes94}
...
\begin{enumerate}
  ...
  \item \textbf{Tarski's decidable geometry}~\cite{tarski48,tarski51,tarskigivant99}:
...
In \textbf{Methods} (\S\ref{sec:methods}) we construct the Pattern-Coherence-Flow Framework (PCF) (alternatively Precedent-Current-Forthcoming).  The generating mechanism is the golden
