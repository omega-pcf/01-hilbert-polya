...
formula~\cite{milne15}. This geometric program for function fields was subsequently completed for $GL_n$ by the work of Drinfeld~\cite{drinfeld77} and Lafforgue~\cite{lafforgue02} via the Langlands correspondence and the Arthur--Selberg trace formula~\cite{oort91}.  Weil's proof exploits the geometric
