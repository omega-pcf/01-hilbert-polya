...
Hasse~\cite{hasse34} (1934) for elliptic curves, Weil~\cite{weil40} (1940) for function fields, and Weil~\cite{weil48} (1948) for all curves
extended to arbitrary varieties by
Deligne~\cite{deligne74} (1974) using the intersection form and the Lefschetz trace
formula~\cite{milne15}. This geometric program for function fields was subsequently completed for $GL_n$ by the work of Drinfeld~\cite{drinfeld77} and Lafforgue~\cite{lafforgue02} via the Langlands correspondence and the Arthur--Selberg trace formula~\cite{arthur89}.  Weil's proof exploits the geometric
