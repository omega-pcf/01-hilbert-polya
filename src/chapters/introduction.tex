...
These results are formally verified in Lean~4 with zero \texttt{sorry} statements; axioms are limited to the geometric constants of the PCF construction~(\S\ref{ssec:axioms}) and the functional equation of Hecke~(\S\ref{ssec:squeeze}).
...
This is the form adopted for formalization (see Appendix~\ref{app:lean}).
\end{proof}
...
This result is machine-verified (see Appendix~\ref{app:lean}).
...
verified---is formalized and fully compiled in Lean~4 with Mathlib (\S\ref{app:lean}).
