...
eigenvalues of specific Hermitian operators.  In a 1982 letter to
Andrew Odlyzko~\cite{polya1982letter}, P\'olya shared his 1914
conjecture: the Riemann hypothesis should be true if the non-trivial
zeros of the zeta function corresponded to eigenvalues of a
self-adjoint physical operator~\cite{odlyzko87}.
